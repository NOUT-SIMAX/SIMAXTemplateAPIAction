...
namespace NOUT\Soap\PackageBase;
...
abstract class AbstractSoapClientBase implements SoapClientInterface
{
    ...
    /**
     * Method returning the SOAP Headers occured during the calls
     * @return array
     */
    ...
    /**
     * Method setting the SOAP Headers of the last calls
     * @param array $outputHeaders
     * @return AbstractSoapClientBase
     */
    private function setOutputHeaders($outputHeaders)
    {
    ...
    public function log($titre){
        ...
        $lastError = $this->getLastErrorForMethod(get_class($this)."::$titre");
        if (!is_null($lastError))
        {
            echo "<h3>ERREURS</h3>";
            echo "<pre style=\"border: solid 1px red; padding: 6px; color: green;\">";
            echo "<table>";
            echo $lastError->xdebug_message;
            echo "</table>";
            echo "</pre>";
        }
