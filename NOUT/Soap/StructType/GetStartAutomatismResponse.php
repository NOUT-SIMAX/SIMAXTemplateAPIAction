...
/**
 * This class stands for GetStartAutomatismResponse StructType
 * @subpackage Structs
 */
class GetStartAutomatismResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for GetStartAutomatismResponse
     * @uses GetStartAutomatismResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\GetStartAutomatismResponse
     */
