...
/**
 * This class stands for TransformIntoResponse StructType
 * @subpackage Structs
 */
class TransformIntoResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for TransformIntoResponse
     * @uses TransformIntoResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\TransformIntoResponse
     */
