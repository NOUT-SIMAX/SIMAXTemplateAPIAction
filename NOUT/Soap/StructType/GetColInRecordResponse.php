...
/**
 * This class stands for GetColInRecordResponse StructType
 * @subpackage Structs
 */
class GetColInRecordResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for GetColInRecordResponse
     * @uses GetColInRecordResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\GetColInRecordResponse
     */
