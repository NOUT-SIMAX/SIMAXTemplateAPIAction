...
class Search extends AbstractStructBase
{
     ...
     */
    public function __construct($table = null, $paramXML = null, \NOUT\Soap\StructType\SpecialParamListType $specialParamList = null, $checksum = null, $displayMode = null, $callingColumn = null, \NOUT\Soap\StructType\CallingInfoType $callingInfo = null)
    {
        $this
            ->setTable($table)
     ...
     * Set Table value
     * @param string $table
     * @return \NOUT\Soap\StructType\Search
     */
