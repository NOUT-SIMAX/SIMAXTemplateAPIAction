...
/**
 * This class stands for SelectPrintTemplateResponse StructType
 * @subpackage Structs
 */
class SelectPrintTemplateResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for SelectPrintTemplateResponse
     * @uses SelectPrintTemplateResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\SelectPrintTemplateResponse
     */
