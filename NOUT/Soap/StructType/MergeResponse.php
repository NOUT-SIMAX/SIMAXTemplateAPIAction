...
/**
 * This class stands for MergeResponse StructType
 * @subpackage Structs
 */
class MergeResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for MergeResponse
     * @uses MergeResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\MergeResponse
     */
