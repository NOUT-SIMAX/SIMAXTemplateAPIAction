...
/**
 * This class stands for ConnectedUser StructType
 * @subpackage Structs
 */
class ConnectedUser extends AbstractStructBase
{
    /**
     * The Form
     * @var string
    ...
    public $Element;
    /**
     * Constructor method for ConnectedUser
     * @uses ConnectedUser::setForm()
     * @uses ConnectedUser::setElement()
     * @param string $form
