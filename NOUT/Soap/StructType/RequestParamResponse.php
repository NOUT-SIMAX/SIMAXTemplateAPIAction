...
/**
 * This class stands for RequestParamResponse StructType
 * @subpackage Structs
 */
class RequestParamResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for RequestParamResponse
     * @uses RequestParamResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\RequestParamResponse
     */
