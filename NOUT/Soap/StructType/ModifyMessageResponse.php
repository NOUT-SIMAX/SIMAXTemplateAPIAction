...
/**
 * This class stands for ModifyMessageResponse StructType
 * @subpackage Structs
 */
class ModifyMessageResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for ModifyMessageResponse
     * @uses ModifyMessageResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\ModifyMessageResponse
     */
