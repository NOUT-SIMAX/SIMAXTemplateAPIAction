...
/**
 * This class stands for ConfirmResponseResponse StructType
 * @subpackage Structs
 */
class ConfirmResponseResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for ConfirmResponseResponse
     * @uses ConfirmResponseResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\ConfirmResponseResponse
     */
