...
/**
 * This class stands for GetTableChildResponse StructType
 * @subpackage Structs
 */
class GetTableChildResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for GetTableChildResponse
     * @uses GetTableChildResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\GetTableChildResponse
     */
