...
/**
 * This class stands for GetSubListContentResponse StructType
 * @subpackage Structs
 */
class GetSubListContentResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for GetSubListContentResponse
     * @uses GetSubListContentResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\GetSubListContentResponse
     */
