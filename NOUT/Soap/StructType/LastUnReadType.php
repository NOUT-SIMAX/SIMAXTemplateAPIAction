...
/**
 * This class stands for LastUnReadType StructType
 * @subpackage Structs
 */
class LastUnReadType extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for LastUnReadType
     * @uses LastUnReadType::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\LastUnReadType
     */
