...
/**
 * This class stands for DisplayResponse StructType
 * @subpackage Structs
 */
class DisplayResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for DisplayResponse
     * @uses DisplayResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\DisplayResponse
     */
