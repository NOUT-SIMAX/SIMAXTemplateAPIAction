...
/**
 * This class stands for ValidateFolder StructType
 * @subpackage Structs
 */
class ValidateFolder extends AbstractStructBase
{
    /**
     * The IDFolder
     * @var string
    ...
    public $IDFolder;
    /**
     * Constructor method for ValidateFolder
     * @uses ValidateFolder::setIDFolder()
     ...
     * Set IDFolder value
     * @param string $iDFolder
     * @return \NOUT\Soap\StructType\ValidateFolder
     */
