...
/**
 * This class stands for GetContentFolderResponse StructType
 * @subpackage Structs
 */
class GetContentFolderResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for GetContentFolderResponse
     * @uses GetContentFolderResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\GetContentFolderResponse
     */
