...
/**
 * This class stands for GetChartResponse StructType
 * @subpackage Structs
 */
class GetChartResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for GetChartResponse
     * @uses GetChartResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\GetChartResponse
     */
