...
/**
 * This class stands for GetCalculationResponse StructType
 * @subpackage Structs
 */
class GetCalculationResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for GetCalculationResponse
     * @uses GetCalculationResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\GetCalculationResponse
     */
