...
/**
 * This class stands for UpdateFolderResponse StructType
 * @subpackage Structs
 */
class UpdateFolderResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for UpdateFolderResponse
     * @uses UpdateFolderResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\UpdateFolderResponse
     */
