...
/**
 * This class stands for SelectChoiceResponse StructType
 * @subpackage Structs
 */
class SelectChoiceResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for SelectChoiceResponse
     * @uses SelectChoiceResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\SelectChoiceResponse
     */
