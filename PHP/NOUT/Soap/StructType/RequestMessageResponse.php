...
/**
 * This class stands for RequestMessageResponse StructType
 * @subpackage Structs
 */
class RequestMessageResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for RequestMessageResponse
     * @uses RequestMessageResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\RequestMessageResponse
     */
