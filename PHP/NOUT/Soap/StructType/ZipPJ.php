...
/**
 * This class stands for ZipPJ StructType
 * @subpackage Structs
 */
class ZipPJ extends AbstractStructBase
{
    /**
     * The IDMessage
     * @var string
    ...
    public $IDMessage;
    /**
     * Constructor method for ZipPJ
     * @uses ZipPJ::setIDMessage()
     ...
     * Set IDMessage value
     * @param string $iDMessage
     * @return \NOUT\Soap\StructType\ZipPJ
     */
