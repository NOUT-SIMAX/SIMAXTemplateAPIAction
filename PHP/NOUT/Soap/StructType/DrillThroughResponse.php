...
/**
 * This class stands for DrillThroughResponse StructType
 * @subpackage Structs
 */
class DrillThroughResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for DrillThroughResponse
     * @uses DrillThroughResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\DrillThroughResponse
     */
