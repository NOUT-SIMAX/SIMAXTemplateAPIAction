...
/**
 * This class stands for ResetPasswordFailedResponse StructType
 * @subpackage Structs
 */
class ResetPasswordFailedResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for ResetPasswordFailedResponse
     * @uses ResetPasswordFailedResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\ResetPasswordFailedResponse
     */
