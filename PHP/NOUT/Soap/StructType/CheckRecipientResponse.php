...
/**
 * This class stands for CheckRecipientResponse StructType
 * @subpackage Structs
 */
class CheckRecipientResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for CheckRecipientResponse
     * @uses CheckRecipientResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\CheckRecipientResponse
     */
