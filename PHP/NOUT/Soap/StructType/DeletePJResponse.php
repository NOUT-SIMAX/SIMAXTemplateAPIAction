...
/**
 * This class stands for DeletePJResponse StructType
 * @subpackage Structs
 */
class DeletePJResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for DeletePJResponse
     * @uses DeletePJResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\DeletePJResponse
     */
