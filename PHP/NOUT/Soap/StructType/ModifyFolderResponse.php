...
/**
 * This class stands for ModifyFolderResponse StructType
 * @subpackage Structs
 */
class ModifyFolderResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for ModifyFolderResponse
     * @uses ModifyFolderResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\ModifyFolderResponse
     */
