...
/**
 * This class stands for UpdateFilterResponse StructType
 * @subpackage Structs
 */
class UpdateFilterResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for UpdateFilterResponse
     * @uses UpdateFilterResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\UpdateFilterResponse
     */
