...
/**
 * This class stands for GetEndAutomatismResponse StructType
 * @subpackage Structs
 */
class GetEndAutomatismResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for GetEndAutomatismResponse
     * @uses GetEndAutomatismResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\GetEndAutomatismResponse
     */
