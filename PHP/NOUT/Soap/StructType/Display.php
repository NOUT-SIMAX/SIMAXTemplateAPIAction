...
/**
 * This class stands for Display StructType
 * @subpackage Structs
 */
class Display extends AbstractStructBase
{
    /**
     * The Table
     * @var string
    ...
    public $ParamXML;
    /**
     * Constructor method for Display
     * @uses Display::setTable()
     * @uses Display::setParamXML()
     * @param string $table
     ...
     * Set Table value
     * @param string $table
     * @return \NOUT\Soap\StructType\Display
     */
