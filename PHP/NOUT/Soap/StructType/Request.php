...
class Request extends AbstractStructBase
{
     ...
     */
    public function __construct($table = null, \NOUT\Soap\StructType\ColListType $colList = null, $condList = null, $maxResult = null, \NOUT\Soap\StructType\SortType $sort1 = null, \NOUT\Soap\StructType\SortType $sort2 = null, \NOUT\Soap\StructType\SortType $sort3 = null, $callingColumn = null, \NOUT\Soap\StructType\CallingInfoType $callingInfo = null)
    {
        $this
            ->setTable($table)
            ->setColList($colList)
     ...
     * Set Table value
     * @param string $table
     * @return \NOUT\Soap\StructType\Request
     */
