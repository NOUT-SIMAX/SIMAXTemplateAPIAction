...
/**
 * This class stands for CreateMessageResponse StructType
 * @subpackage Structs
 */
class CreateMessageResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for CreateMessageResponse
     * @uses CreateMessageResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\CreateMessageResponse
     */
