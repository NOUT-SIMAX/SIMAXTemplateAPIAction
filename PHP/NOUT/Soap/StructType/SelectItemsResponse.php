...
/**
 * This class stands for SelectItemsResponse StructType
 * @subpackage Structs
 */
class SelectItemsResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for SelectItemsResponse
     * @uses SelectItemsResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\SelectItemsResponse
     */
