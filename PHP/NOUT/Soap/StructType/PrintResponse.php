...
/**
 * This class stands for PrintResponse StructType
 * @subpackage Structs
 */
class PrintResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\PrintResponse
     */
