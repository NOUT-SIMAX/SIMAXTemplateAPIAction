...
/**
 * This class stands for ModifyResponse StructType
 * @subpackage Structs
 */
class ModifyResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for ModifyResponse
     * @uses ModifyResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\ModifyResponse
     */
