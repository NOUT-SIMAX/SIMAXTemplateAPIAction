...
/**
 * This class stands for GetFolderListResponse StructType
 * @subpackage Structs
 */
class GetFolderListResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for GetFolderListResponse
     * @uses GetFolderListResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\GetFolderListResponse
     */
