...
/**
 * This class stands for GetPlanningInfoResponse StructType
 * @subpackage Structs
 */
class GetPlanningInfoResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for GetPlanningInfoResponse
     * @uses GetPlanningInfoResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\GetPlanningInfoResponse
     */
