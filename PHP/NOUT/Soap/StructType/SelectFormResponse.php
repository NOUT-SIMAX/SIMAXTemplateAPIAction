...
/**
 * This class stands for SelectFormResponse StructType
 * @subpackage Structs
 */
class SelectFormResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for SelectFormResponse
     * @uses SelectFormResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\SelectFormResponse
     */
