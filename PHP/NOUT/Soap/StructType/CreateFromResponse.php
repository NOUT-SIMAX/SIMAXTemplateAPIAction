...
/**
 * This class stands for CreateFromResponse StructType
 * @subpackage Structs
 */
class CreateFromResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for CreateFromResponse
     * @uses CreateFromResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\CreateFromResponse
     */
