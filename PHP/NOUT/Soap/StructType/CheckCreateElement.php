...
/**
 * This class stands for CheckCreateElement StructType
 * @subpackage Structs
 */
class CheckCreateElement extends AbstractStructBase
{
    /**
     * The IDMessage
     * @var string
    ...
    public $IDMessage;
    /**
     * Constructor method for CheckCreateElement
     * @uses CheckCreateElement::setIDMessage()
     ...
     * Set IDMessage value
     * @param string $iDMessage
     * @return \NOUT\Soap\StructType\CheckCreateElement
     */
