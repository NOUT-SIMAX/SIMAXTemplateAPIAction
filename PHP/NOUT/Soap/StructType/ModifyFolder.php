...
/**
 * This class stands for ModifyFolder StructType
 * @subpackage Structs
 */
class ModifyFolder extends AbstractStructBase
{
    /**
     * The IDFolder
     * @var string
    ...
    public $IDFolder;
    /**
     * Constructor method for ModifyFolder
     * @uses ModifyFolder::setIDFolder()
     ...
     * Set IDFolder value
     * @param string $iDFolder
     * @return \NOUT\Soap\StructType\ModifyFolder
     */
