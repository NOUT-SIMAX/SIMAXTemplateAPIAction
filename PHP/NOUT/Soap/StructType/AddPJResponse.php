...
/**
 * This class stands for AddPJResponse StructType
 * @subpackage Structs
 */
class AddPJResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for AddPJResponse
     * @uses AddPJResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\AddPJResponse
     */
