...
/**
 * This class stands for UpdateMessageResponse StructType
 * @subpackage Structs
 */
class UpdateMessageResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for UpdateMessageResponse
     * @uses UpdateMessageResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\UpdateMessageResponse
     */
