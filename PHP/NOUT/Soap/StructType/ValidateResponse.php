...
/**
 * This class stands for ValidateResponse StructType
 * @subpackage Structs
 */
class ValidateResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for ValidateResponse
     * @uses ValidateResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\ValidateResponse
     */
