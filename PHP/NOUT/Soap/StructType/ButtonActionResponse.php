...
/**
 * This class stands for ButtonActionResponse StructType
 * @subpackage Structs
 */
class ButtonActionResponse extends AbstractStructBase
{
    /**
     * The xml
     * @var string
    ...
    public $xml;
    /**
     * Constructor method for ButtonActionResponse
     * @uses ButtonActionResponse::setXml()
     * @param string $xml
     */
     ...
     * Set xml value
     * @param string $xml
     * @return \NOUT\Soap\StructType\ButtonActionResponse
     */
